            ...
            <v-card style="height: 100vh;">
                ...
                <v-card-text>
                    ...
                    <v-list dense single-line>
                        ...
                        <v-list-item>
                            <v-list-item-content>
                                <v-list-item-title> {{getTotal().sc|toPHP}}</v-list-item-title>
                                <v-list-item-subtitle>Service Fee</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                            <v-list-item-content>
                                <v-list-item-title>{{ item.fees.delivery.platform + item.fees.delivery.rider | toPHP }}</v-list-item-title>
