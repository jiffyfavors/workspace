    ...
    <v-flex xs12 md4 sm6 lg3 class="pa-2" v-if="loaded">
        ...
        <v-bottom-sheet inset v-model="actionSheet">
            <v-list single-line dense>
                ...
                <v-list-item-group>
                    <v-list-item @click="editedIndex=0, dialog = true">
                        <v-list-item-icon>
                ...
                <v-list-item-group>
                    <v-list-item>
                        <v-list-item-icon>
                            <v-icon small color="blue">mdi-link-box</v-icon>
                        </v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>Link to Merchant</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-list-item-group>
                <v-list-item-group>
                    <v-list-item :to="'/menu/'+storeid" target="_blank">
                        <v-list-item-icon>
    ...
    data() {
            return {
                ...
                dropzoneOptions: {
                    ...
                    dictDefaultMessage: `<p class='text-default'><v-icon small color="blue">mdi-store</v-icon> Drag Images or Click Here</p>
