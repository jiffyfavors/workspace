         ...
         <v-toolbar bottom width="100%" v-show="!sheet"  class="shopresponsive">
            ...
            <v-chip class="white--text" color="blue">
              {{price|toPHP}}
               ...
               <v-spacer></v-spacer>
            <v-btn @click="sheet = !sheet" tile outlined color="blue">
              Book Now
            </v-btn>
          </v-toolbar>
    </v-layout>
              ...
              <v-card class="mx-auto" width="500" min-height="100%" max-width="100%">
                <v-list two-line subheader>
                  ...
                  <v-list-item>
                    <v-layout wrap>
                      <v-flex xs12 md12 sm12>
                        <v-select flat dense :disabled="data.origin==='PBT' && data.type.includes('Shared')" label="Pickup Area" single-line required v-model="pickup" :items="locations.find(x=>x.code==data.origin).locations" item-text="name" return-object>
                        </v-select>
                  ...
                  <v-list-item>
                    <v-layout wrap>
                      <v-flex xs12 md12 sm12>
                        <v-select flat dense :disabled="data.desti==='PBT' && data.type.includes('Shared')" label="Drop Area" single-line required v-model="dropoff" :items="locations.find(x=>x.code==data.desti).locations" item-text="name" return-object>
                        </v-select>
                      ...
                      <v-alert v-if="data.desti==='PBT' && data.type.includes('Shared')" dense text type="warning">
                        All Drop Off on Shared Transfer is set to <strong>Port Barton Common Terminal</strong>
                      </v-alert>
                    </v-layout>
                  </v-list-item>
                </v-list>
