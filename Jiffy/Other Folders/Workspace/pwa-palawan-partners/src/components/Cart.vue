          ...
          <v-container v-if="ifComplete">
            <div class="toursection eln">
              ...
              <article class="article">
                ...
                <p style="margin: 10px 0; white-space: normal;">Please check you booking history.
                </p>
              </article>
            </div>
          </v-container>
...
export default {
  ...
  watch: {
    ...
    getCart(cart) {
      ...
      cart.forEach(data => {
        ...
        data.rates.extra.fees.forEach(a=>{
          price = price + (parseFloat(a.rate) *parseInt(data.pax))
        })
  ...
  methods: {
    ...
    saveToDb() {
      ...
      this.loading = true
      fetch('https://api.diskubrepalawan.com/index_dev.php/encode-ds-partner', {
        ...
        this.isShow = false
        this.$store.commit('emptyCart', null);
      })
