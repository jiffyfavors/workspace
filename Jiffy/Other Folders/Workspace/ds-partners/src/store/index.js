...
const store = new Vuex.Store({
    ...
    getters: {
        ...
        getRequestedRates: (state) => {
            return state.requested_rate
        },
        getTransfers : (state)=>{
            return state.data.transfers
        },
            getContractedRates : (state)=>{
            return state.data.contracted
        },
        getIfReady: (state) => {
        ...
        getCartTotal: (state) => {
            ...
            state.cart.forEach(function(data) {
                total = total + data.rates.base + data.rates.extra.dropoff.rate + data.rates.extra.pickup.rate
            })
            return total
        },
    ...
    mutations: {
        ...
        setUpdatedRate: function(state,data){
            state.data.contracted = Object.assign({},data)
        },
        ...
        addData: function(state, data){
         ...
         updateData: function(state, data){
            ...
            state.data.contracted = data.contracted
            state.data.transfers =  data.transfers
        },
        
        clearRequestRates: function(state, data) {

            state.requested_rate = data
        },
        addRequestedRate: function(state, data) {

            state.requested_rate.push(data)
        },
        removeRequestedRate: function(state, data) {
            state.requested_rate.splice(state.requested_rate.indexOf(data), 1)
        },
        ...
        updateCurrentUser: function(state, data) {
            state.currentUser = Object.assign({}, data.data)
    ...
    actions: {
        ...
        addRequestedRate: function(state, data) {
            context.commit('addRequestedRate', data)
        },

        clearRequestRates: function(state, data) {
            context.commit('clearRequestRates', data)
        },
