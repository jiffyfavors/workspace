<template>
    <v-card flat id="create" class="overflow-hidden">
                ...
                <v-tabs-items v-model="tab">
                    <v-tab-item v-if="categories.length>0" :key="categories[0].name">
                        <v-card>
                            ...
                            <v-card-text>
                                <v-data-table v-model="selected" :headers="headers" :items="getFood(categories[0])" item-key="id" show-select class="elevation-1"> </v-data-table>
                            </v-card-text>
                        </v-card>
                    </v-tab-item>
                                ...
                                <v-card class="mx-auto" max-width="100%" outlined>
                                    <v-list-item three-line dense>
                                        <v-list-item-content>
                                            <h3>{{ fooditem.name }}</h3>
                                            <small>
                                                <p style="font-style:italic">{{ fooditem.desc }}</p>
                                            </small>
                                        ...
                                        <v-list-item-avatar tile v-if="fooditem.img!=''" size="100">
                                            <v-img :src="fooditem.img"></v-img>
                                        </v-list-item-avatar>
                                    </v-list-item>
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
        ...
        <v-bottom-sheet v-model="fooddialog" scrollable inset>
            <v-card>
                <v-card-title>
                    <span class="headline">{{ formFoodTitle }}</span>
                </v-card-title>
                <v-card-text id="foodcard" style="height: 500px;">
                    <v-img v-if="editedFoodIndex>-1" min-width="200px" max-height="200px" min-height="50px" class="elevation-6" :src="editFoodItem.img" @click.stop="imagediag= true" />
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" sm="12" md="12">
                                <v-textarea rows="3" solo auto-grow dense placeholder="Description" label="Description" v-model="editFoodItem.desc" outlined /> </v-col>
