                ...
                <v-layout wrap class="mt-5">
                    ...
                    <v-flex xs8 sm8 md8> Convenience Fee
                        <v-tooltip v-model="showtooltip" bottom>
                            ...
                            <span> We charging certain amount base on your total order value in order for us to improve our service, provide rider incentives, and give perks and discount to customer. </span>
                        </v-tooltip>
                    </v-flex>
        ...
        recalculateFees() {
            ...
            this.$store.dispatch('admin/getAreaByLocation', {
                ...
                this.$axios.$get('/distance/', {
                    ...
                    const update_data = cloneDeep(this.item)
