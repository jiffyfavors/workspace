...
export default {
    ...
    computed: {
        ...
        merchants() {
             if (this.flag === 'All') return this.$store.getters['map/getShopsAsc']
            else if (this.flag === 'Draft') return this.$store.getters['map/getShopsAsc'].filter(x => x.draft === true)
            else return this.$store.getters['map/getShopsAsc'].filter(x => x.draft === false)
        },
        areas() {
            var areas = []
            var values = []
