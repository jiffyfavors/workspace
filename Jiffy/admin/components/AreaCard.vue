    ...
    <v-flex xs12 md4 sm4 lg3 class="ma-1">
        <v-card class="mx-auto" max-width="400">
            ...
            <v-card-text>
                ...
                <v-tabs v-model="tab_fees_1" centered center-active dense>
                    <v-tab key="delivery" href="#delivery">Food</v-tab>
                    <v-tab key="biller" href="#biller">Bills</v-tab>
                    <v-tab key="shop" href="#shop">Shop</v-tab>
                    <v-tabs-items v-model="tab_fees_1">
                        <v-tab-item key="delivery" value="delivery">
                            <v-layout wrap>
                                ...
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.distance_platform|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.distance_rider|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fixed Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.rider_fixed_fee|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Min. Delivery Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.min_df|toMoney(item.locale, item.currency)}}</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Min. Distance</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.min_distance}} km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Min. Service Charge</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.food.sc_min_value|toMoney(item.locale, item.currency)}}/order</strong>
                                </v-flex>
                            </v-layout>
                        </v-tab-item>
                        <v-tab-item key="biller" value="biller">
                            <v-layout wrap>
                                ...
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.biller.distance_platform|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fixed Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.biller.rider_fixed_fee|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.biller.distance_rider|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                            </v-layout>
                        </v-tab-item>
                        <v-tab-item key="shop" value="shop">
                            <v-layout wrap>
                                <v-flex xs6 sm6 md6>
                                    <strong>Platform Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.shop.distance_platform|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fixed Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.shop.rider_fixed_fee|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>Rider Fee</strong>
                                </v-flex>
                                <v-flex xs6 sm6 md6>
                                    <strong>{{item.fees.shop.distance_rider|toMoney(item.locale, item.currency)}}/km</strong>
                                </v-flex>
                            </v-layout>
                        </v-tab-item>
                    </v-tabs-items>
                    ...
                    <v-card-text>
                        <v-layout wrap>
                            ...
                            <v-tabs v-model="tab_fees" centered center-active dense>
                                ...
                                <v-tab key="shop" href="#shop">Shop Fees</v-tab>
                                <v-tabs-items v-model="tab_fees">
                                    <v-tab-item key="map" value="map">
                                        ...
                                        <v-layout wrap>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.distance_platform" type="number" dense label="Platform Fee" outlined placeholder="Fee(Platform)" /></v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.distance_rider" type="number" dense label="Rider Fee" outlined placeholder="Fee(Rider)"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.rider_fixed_fee" type="number" dense label="Fixed Rider Fee" outlined placeholder="Rider Fixed Fee"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.min_distance" type="number" dense label="Min. Distance" outlined placeholder="Min. Distance"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.min_df" type="number" dense label="Min. Delivery Fee" outlined placeholder="Delivery Fee(min)"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.food.sc_min_value" type="number" dense label="Min. SC" outlined placeholder="SC(Min)"></v-text-field>
                                            </v-flex>
                                        </v-layout>
                                    </v-tab-item>
                                    <v-tab-item key="biller" value="biller">
                                        <v-layout wrap>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.biller.rider_fixed_fee" type="number" dense label="Fixed Rider Fee" outlined placeholder="Rider Fixed Fee"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                    ...
                                    <v-tab-item key="shop" value="shop">
                                        <v-layout wrap>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.shop.rider_fixed_fee" type="number" dense label="Fixed Rider Fee" outlined placeholder="Rider Fixed Fee"></v-text-field>
                                            </v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.shop.distance_platform" type="number" dense label="Platform Fee" outlined placeholder="Fee(Platform)" /></v-flex>
                                            <v-flex xs4 md4>
                                                <v-text-field v-model.number="area.fees.shop.distance_rider" type="number" dense label="Rider Fee" outlined placeholder="Fee(Rider)"></v-text-field>
                                            </v-flex>
                                        </v-layout>
                                    </v-tab-item>
                                </v-tabs-items>
